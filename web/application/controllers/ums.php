...
class Ums extends CI_Controller {
    ...
    function postEvent() {
        ...
        $retParamsCheck = $this -> utility -> isPraramerValue($content, $array = array('appkey', 'event_identifier', 'time', 'activity', 'version', "device_identifier", "session_identifier", "fragment"));
