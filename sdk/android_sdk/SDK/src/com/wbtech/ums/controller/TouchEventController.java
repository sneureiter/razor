...
public class TouchEventController {
    static final String EVENTURL = UmsConstants.preUrl + UmsConstants.touchEventUrl;
    public static boolean postTouchEventInfo(Handler handler, Context context, PostObjTouchEvent event) {
        try {
            ...
            JSONObject localJSONObject = AssembJSONObj.getTouchEventJSONobj( event);
            ...
            if (1 == CommonUtil.getReportPolicyMode(context)
                ...
                try {
                    ...
                    if (!info.isFlag()) {
                        CommonUtil.saveInfoToFile(handler, "touchEventInfo", localJSONObject, context);
                        return false;
                    }
                } catch (Exception e) {
            ...
            CommonUtil.printLog("UMSAgent", "Exception occurred in postTouchEventInfo()");
            e.printStackTrace();
            return false;
        }
        return true;
